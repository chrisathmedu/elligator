...
-- Original: Theorem 3 Proof B (3.2 forward statement)
lemma point_in_ϕ_over_F_of_point_of_point_props 
  (t s : F)
  (s_h1 : s ≠ 0)
  (s_h2 : (s^2 - 2) * (s^2 + 2) ≠ 0)
  (q : ℕ)
...
-- Original: Theorem 3 Proof C (3.2 backward statement)
lemma point_props_of_point_in_ϕ_over_F_of_point  
  (t s : F)
  (s_h1 : s ≠ 0)
  (s_h2 : (s^2 - 2) * (s^2 + 2) ≠ 0)
  (q : ℕ)
